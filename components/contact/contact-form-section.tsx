      ...
      <div className="grid lg:grid-cols-5 gap-10 lg:gap-16 items-start">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <label className="block text-lg font-medium text-white/60 mb-3">
                ...
                {serviceOptions.map((opt) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Icon
                          className={`w-4 h-4 transition-colors ${active ? "text-primary" : "text-white/40 group-hover:text-white/60"}`}
                        />
                      </div>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                <label
                  htmlFor="name"
                  className="block text-lg font-medium text-white/60 mb-2"
                >
                  Full Name
                </label>
                <Input
          ...
          <div className="sticky top-28 space-y-6">
            ...
            <div className="relative rounded-2xl overflow-hidden group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <p className="text-primary text-xs uppercase tracking-[0.2em] font-medium mb-1">
                  Our Studio
                </p>
            ...
            <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-6 space-y-5">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-start gap-3 text-lg text-white/55"
                  >
